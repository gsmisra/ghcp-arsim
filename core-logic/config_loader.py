...
DEFAULTS = {
    ...
    "APP_ROUTE_GENERATE_DOCUMENT": "/api/generate/document",
    "APP_ROUTE_GENERATE_CONFLUENCE": "/api/generate/confluence",
    "APP_ROUTE_GENERATE_JIRA": "/api/generate/jira",
    ...
    "DEFAULT_GENERATION_MODE": "semantic_llm",
